...
('Designer Gráfico', 'Desenvolvimento de materiais gráficos criativos para campanhas publicitárias e branding.', 'Domínio de Photoshop e Illustrator, criatividade e atenção aos detalhes', 'Superior Completo ou Técnico em Design Gráfico', 'Itabuna, BA', 'remoto', 3500, 'Creative Agency', 'publicidade e marketing', 'talentos@creativeagency.com', 'Design', 'clt', 'De segunda à sexta, 09:00 às 16:00', false, 1),
...
('Consultor de Vendas', 'Atuação em vendas consultivas.', 'Conhecimento em técnicas de negociação e comunicação eficaz', 'Ensino Médio Completo, desejável formação em Administração', 'Ilhéus, BA', 'remoto', 2500, 'Comercial Bahia', 'comércio e serviços', 'consultoria@comercialbahia.com', 'Consultor', 'clt', 'De segunda à sexta, 09:00 às 16:00', false, 2),
